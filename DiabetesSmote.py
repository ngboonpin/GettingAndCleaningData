...
path_output_file = path_output / 'diabetesSmote.csv'
...
a = df.replace({'Pregnant': {0:'No', 1:'Yes'}})
#a = a.replace({'cp':{0:'Normal',1:'Typical Angina', 2:'Atypical Angina',3:'Non-angina',4:'Asymptomatic'}})
a = a.groupby(['Pregnant','Age']).agg({'Insulin':['min','max','count']})

#a.to_csv("C:/Documents/Telematics/ACentric/UI/result.csv")
